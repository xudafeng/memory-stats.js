...
function MemoryStats(options = {}){
	...
	container.id	= 'stats';
	container.style.cssText = `width:${containerWidth}px;opacity:0.9;cursor:pointer`;
	...
	msText.id	= 'msText';
	msText.style.cssText = 'color:#0f0;font-family:Helvetica,Arial,sans-serif;font-size:9px;line-height:15px';
	msText.innerHTML= 'Memory';
	msDiv.appendChild( msText );

	var msGraph	= document.createElement( 'div' );
	msGraph.id	= 'msGraph';
	msGraph.style.cssText = `position:relative;width:${containerWidth - 3 * 2}px;height:30px;background-color:#0f0`;
